...
class PollingIntegrationTest extends IntegrationTest {
    ...
    void setUp() {
        ...
        participant1 = Participant.of(study, memberDto1.member(), "parti1");
        participant2 = Participant.of(study, memberDto2.member(), "parti2");
        participant3 = Participant.of(study, memberDto3.member(), "parti3");
